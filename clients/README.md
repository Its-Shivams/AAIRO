...
<!-- How To add React With Google Sheet ? -->


// create a new google sheet and add the following columns: Name, Email, Date then click on extensions > apps script and paste the following code:
...
// then click on deploy > new deployment > select type as web app > give it a name and set access to anyone with the link and click on deploy and copy the web app url and replace the url in the fetch function in the handleSubmit function in the Events.jsx file.
