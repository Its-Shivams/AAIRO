...
const Calendar = () => {
  ...
  const getColorStyle = (colorName) => {
    const colorMap = {
      'dark green': 'var(--aairo-calendar-dark-green)',
      'light blue': 'var(--aairo-calendar-light-blue)',
      red: 'var(--aairo-calendar-red)',
      blue: 'var(--aairo-calendar-blue)',
      green: 'var(--aairo-calendar-green)',
      yellow: 'var(--aairo-calendar-yellow)',
      orange: 'var(--aairo-calendar-orange)',
      black: 'var(--aairo-calendar-black)'
    };

    const lowerColor = colorName.toLowerCase();
    return colorMap[lowerColor] || 'var(--aairo-calendar-default)';
  };
  ...
  const renderCalendar = () => {
    ...
    for (let i = 0; i < firstDayOfMonth; i++) {
      days.push(
        <div
          key={`empty-${i}`}
          className="h-12 md:h-16 p-1 md:p-2"
        ></div>
      );
    }
          ...
          style={
            hasEvent
              ? {
                  ...
                  border: isSelected
                    ? "2px solid var(--aairo-calendar-selected)"
                    : "none"
                }
              : {}
          }
