...
This isn't just software—it's a movement to restore dignity, boost morale, and create a culture where every effort counts.`,
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="min-h-screen relative flex items-center justify-center bg-[var(--aairo-surface)] overflow-hidden pt-20">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center lg:text-left max-w-4xl lg:max-w-2xl xl:max-w-3xl mx-auto lg:mx-0 py-8 lg:pr-10 xl:pr-0">
            <div className="mb-4 lg:mb-6 pb-6 lg:pb-10">
              <h1 className="text-lg sm:text-xl font-semibold text-[var(--aairo-text-secondary)] mb-1 tracking-wider uppercase">
                AAIRO
              </h1>
              <h1 className="text-lg sm:text-xl font-semibold text-[var(--aairo-text-secondary)] mb-2 tracking-wider uppercase">
                Robotics & AI Society
              </h1>
            </div>

            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 lg:mb-8 leading-tight bg-gradient-to-r from-white to-[var(--aairo-text-tertiary)] bg-clip-text text-transparent">
              Inspiring the Future with <br className="hidden sm:block" />
              <span className="bg-gradient-to-r from-[var(--aairo-info)] via-[var(--aairo-purple)] to-[var(--aairo-pink)] bg-clip-text text-transparent bg-[length:200%_200%] animate-[gradient-shift_6s_ease_infinite]">
                Artificial Intelligence & Robotics
              </span>
            </h2>

            <p className="text-base sm:text-lg md:text-xl text-[var(--aairo-text-tertiary)] mb-8 lg:mb-12 leading-relaxed max-w-3xl mx-auto lg:mx-0">
            ...
            <div className="flex gap-4 sm:gap-6 justify-center lg:justify-start flex-wrap">
              <Link
                to="/membership"
                className="px-6 py-3 sm:px-8 sm:py-4 rounded-full font-semibold inline-flex items-center gap-2 transition-all duration-300 relative overflow-hidden z-10 bg-gradient-to-r from-[var(--aairo-info)] to-[var(--aairo-purple)] text-white shadow-lg shadow-[var(--aairo-info-30)] hover:-translate-y-1 hover:shadow-xl hover:shadow-[var(--aairo-info-40)] before:absolute before:top-0 before:left-0 before:w-0 before:h-full before:bg-white/10 before:transition-all before:duration-300 before:ease-in before:z-[-1] hover:before:w-full text-sm sm:text-base"
              >
                Join Us
              </Link>
              ...
              <Link
                to="/event"
                className="px-6  lg:hidden py-3 sm:px-8 sm:py-4 rounded-full font-semibold inline-flex items-center gap-2 transition-all duration-300 relative overflow-hidden z-10 bg-gradient-to-r from-[var(--aairo-orange)] to-[var(--aairo-red)] text-[var(--aairo-yellow)] drop-shadow-xl shadow-[var(--aairo-yellow)] hover:-translate-y-1 hover:shadow-xl hover:shadow-[var(--aairo-info-40)] before:absolute before:top-0 before:left-0 before:w-0 before:h-full before:bg-white/10 before:transition-all before:duration-300 before:ease-in before:z-[-1] hover:before:w-full text-sm sm:text-base"
              >
               See Events
              </Link>
              ...
              <Link
                to="/about"
                className="px-6 py-3 rounded-full font-semibold inline-flex items-center gap-2 transition-all duration-300 border border-[var(--aairo-info)] text-[var(--aairo-info)] hover:bg-[var(--aairo-info)] hover:text-white text-sm"
              >
                Learn More
              </Link>
            </div>
        ...
        <div className="absolute hidden lg:block z-20 w-24 h-8 sm:w-80 sm:h-12 bottom-4 lg:bottom-13 lg:right-70">
          <Link
            ...
            className="group relative w-full h-full flex items-center justify-center text-white text-xs sm:text-sm font-bold
               bg-gradient-to-r from-[var(--aairo-orange)] to-[var(--aairo-orange-dark)]
               rounded-full overflow-hidden
               shadow-lg shadow-[var(--aairo-orange)]/50
               hover:shadow-xl hover:shadow-[var(--aairo-orange)]/70
               hover:scale-105
      ...
      {/* Overview Section */}
      <section className="py-24 bg-gradient-to-b from-[var(--aairo-surface)] to-[var(--aairo-surface-light)] relative overflow-hidden">
        <div className="absolute -top-1/2 -left-1/2 w-[200%] h-[200%] bg-[radial-gradient(circle,var(--aairo-info-05)_0%,transparent_70%)] animate-[rotate_60s_linear_infinite] z-0"></div>
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-extrabold mb-12 text-center text-[var(--aairo-text-primary)] relative z-10">
            AAIRO Overview
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12 relative z-10">
            <Link
              to="/about"
              className="bg-[var(--aairo-surface-light-50)] border border-[var(--aairo-info-20)] rounded-2xl p-8 text-center cursor-pointer transition-all duration-400 backdrop-blur-md relative overflow-hidden hover:-translate-y-2 hover:scale-102 hover:border-[var(--aairo-info)] hover:shadow-lg hover:shadow-[var(--aairo-info-20)] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-gradient-to-r before:from-transparent before:via-[var(--aairo-info-10)] before:to-transparent before:-translate-x-full before:transition-all before:duration-600 before:ease-in-out hover:before:translate-x-full"
            >
              <div className="w-18 h-18 bg-gradient-to-r from-[var(--aairo-info)] to-[var(--aairo-purple)] rounded-full flex items-center justify-center mx-auto mb-6 text-white text-3xl shadow-lg shadow-[var(--aairo-info-30)] transition-all duration-300 group-hover:rotate-12 group-hover:scale-110">
                <FaGlobe />
              </div>
              <h3 className="text-2xl font-bold mb-4 text-[var(--aairo-text-primary)]">
                About Us
              </h3>
              <p className="text-[var(--aairo-text-secondary)] leading-relaxed">
      ...
      {/* Latest Buzz Section */}
      <section className="py-24 bg-[var(--aairo-surface)] relative">
        <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[var(--aairo-info-50)] to-transparent"></div>
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-extrabold mb-12 text-center bg-gradient-to-r from-[var(--aairo-info)] to-[var(--aairo-purple)] bg-clip-text text-transparent uppercase tracking-wider">
            LATEST BUZZ
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {buzzItems.map((item) => (
              <div
                key={item.id}
                className="bg-[var(--aairo-surface-light-30)] border border-[var(--aairo-info-20)] rounded-2xl p-6 transition-all duration-400 relative overflow-hidden hover:bg-[var(--aairo-info-10)] hover:-translate-y-1 hover:shadow-lg hover:shadow-[var(--aairo-info-20)] before:absolute before:top-0 before:left-0 before:w-1 before:h-0 before:bg-gradient-to-b from-[var(--aairo-info)] to-[var(--aairo-purple)] before:transition-all before:duration-400 hover:before:h-full"
              >
                <span className="text-[var(--aairo-info)] text-sm font-semibold mb-3 flex items-center gap-2">
                  <span className="text-xs">🗓</span> {item.date}
                </span>
                <h3 className="text-xl font-bold mb-4 text-[var(--aairo-text-primary)] leading-snug">
                  {item.title}
                </h3>
                <p className="text-[var(--aairo-text-secondary)] mb-5 leading-relaxed">
                  {item.excerpt}
                </p>
                {/* <span className="inline-block bg-[var(--aairo-info-20)] text-[var(--aairo-info)] px-3 py-1 rounded-full text-xs font-semibold tracking-wider uppercase">
                  {item.tag}
                </span> */}
              </div>
            ))}
      ...
      {/* About Section */}
      <section className="py-24 bg-gradient-to-b from-[var(--aairo-surface-light)] to-[var(--aairo-surface)]">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-extrabold mb-12 text-center text-[var(--aairo-text-primary)]">
            About AAIRO
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="text-[var(--aairo-text-tertiary)]">
              <h3 className="text-2xl text-[var(--aairo-info)] mt-8 mb-4 inline-block relative after:absolute after:-bottom-1 after:left-0 after:w-12 after:h-1 after:bg-gradient-to-r after:from-[var(--aairo-info)] after:to-[var(--aairo-purple)] after:rounded">
                Vision
              </h3>
              ...
              <ul className="mb-8 pl-6">
                <li className="mb-3 relative before:absolute before:-left-6 before:top-1 before:text-[var(--aairo-info)] before:content-['✓']">
            ...
            <div className="grid gap-6 relative pl-8 before:absolute before:top-0 before:left-0 before:w-1 before:h-full before:bg-gradient-to-b before:from-transparent before:via-[var(--aairo-info)] before:to-transparent">
              <div className="flex items-start gap-6 p-6 bg-[var(--aairo-surface-light-30)] rounded-xl border border-[var(--aairo-info-10)] transition-all duration-300 hover:bg-[var(--aairo-info-10)] hover:translate-x-2">
                <FaRobot className="text-3xl text-[var(--aairo-info)] mt-1 flex-shrink-0" />
                <div>
                  <h4 className="text-xl font-bold mb-3 text-[var(--aairo-text-primary)]">
                    Robotics Innovation
                  </h4>
                  <p className="text-[var(--aairo-text-secondary)] leading-relaxed">
              ...
              <div className="flex items-start gap-6 p-6 bg-[var(--aairo-surface-light-30)] rounded-xl border border-[var(--aairo-info-10)] transition-all duration-300 hover:bg-[var(--aairo-info-10)] hover:translate-x-2">
                <FaBrain className="text-3xl text-[var(--aairo-info)] mt-1 flex-shrink-0" />
                <div>
                  <h4 className="text-xl font-bold mb-3 text-[var(--aairo-text-primary)]">
                    AI Research
                  </h4>
              ...
              <div className="flex items-start gap-6 p-6 bg-[var(--aairo-surface-light-30)] rounded-xl border border-[var(--aairo-info-10)] transition-all duration-300 hover:bg-[var(--aairo-info-10)] hover:translate-x-2">
                <FaGraduationCap className="text-3xl text-[var(--aairo-info)] mt-1 flex-shrink-0" />
                <div>
                  <h4 className="text-xl font-bold mb-3 text-[var(--aairo-text-primary)]">
                    Skill Development
                  </h4>
              ...
              <div className="flex items-start gap-6 p-6 bg-[var(--aairo-surface-light-30)] rounded-xl border border-[var(--aairo-info-10)] transition-all duration-300 hover:bg-[var(--aairo-info-10)] hover:translate-x-2">
                <FaTrophy className="text-3xl text-[var(--aairo-info)] mt-1 flex-shrink-0" />
                <div>
                  <h4 className="text-xl font-bold mb-3 text-[var(--aairo-text-primary)]">
                    Competitions
                  </h4>
      ...
      {/* Projects Section */}
      <section className="py-24 bg-[var(--aairo-surface)] relative">
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[var(--aairo-info-50)] to-transparent"></div>
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-extrabold mb-6 text-center text-[var(--aairo-text-primary)]">
            Our Projects
          </h2>
          <p className="text-xl text-[var(--aairo-text-tertiary)] mb-12 text-center max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {projects.map((project) => (
              <div
                key={project.id}
                className="bg-[var(--aairo-surface-light-30)] border border-[var(--aairo-info-20)] rounded-2xl overflow-hidden transition-all duration-400 relative hover:-translate-y-2 hover:scale-102 hover:border-[var(--aairo-info)] hover:shadow-xl hover:shadow-[var(--aairo-info-20)] after:absolute after:top-0 after:left-0 after:right-0 after:bottom-0 after:bg-gradient-to-t after:from-[var(--aairo-surface-80)] after:to-transparent after:opacity-0 after:transition-all after:duration-300 hover:after:opacity-100"
              >
                ...
                <div className="p-6 relative z-10">
                  <h3 className="text-xl font-bold mb-4 text-[var(--aairo-text-primary)]">
                    {project.title}
                  </h3>
                  <p className="text-[var(--aairo-text-secondary)] mb-6 leading-relaxed">
                    {project.description}
                  </p>
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.technologies.map((tech, index) => (
                      <span
                        key={index}
                        className="bg-[var(--aairo-info-20)] text-[var(--aairo-info)] px-3 py-1 rounded-full text-xs font-semibold tracking-wider"
                      >
                        {tech}
                      </span>
                    ))}
          ...
          <div className="flex items-center mt-10 relative text-center mx-auto  gap-6 justify-center">
            <Link
              to="/projects"
              className=" px-8 py-4 mx-auto rounded-full font-semibold inline-flex items-center transition-all duration-300 relative overflow-hidden z-10 bg-gradient-to-r from-[var(--aairo-info)] to-[var(--aairo-purple)] text-white shadow-lg shadow-[var(--aairo-info-30)] hover:-translate-y-1 hover:shadow-xl hover:shadow-[var(--aairo-info-40)] before:absolute before:top-0 before:left-0 before:w-0 before:h-full before:bg-white/10 before:transition-all before:duration-300 before:ease-in before:z-[-1] hover:before:w-full"
            >
              See More
            </Link>
          </div>
      ...
      {/* Blog Section */}
      <section className="py-24 bg-[var(--aairo-surface)]">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-extrabold mb-12 text-center text-[var(--aairo-text-primary)]">
            Latest Blog Posts
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {BLOG_DATA.map((post) => (
              <div
                key={post.id}
                className="bg-[var(--aairo-surface-light-30)] border border-[var(--aairo-info-20)] rounded-2xl overflow-hidden transition-all duration-400 hover:-translate-y-2 hover:border-[var(--aairo-info)] hover:shadow-xl hover:shadow-[var(--aairo-info-20)] group"
              >
                <div className="h-48 bg-gradient-to-r from-[var(--aairo-surface-light)] to-[var(--aairo-slate-700)] flex items-center justify-center text-[var(--aairo-info)] text-5xl transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-[var(--aairo-info)] group-hover:to-[var(--aairo-purple)] group-hover:text-white">
                ...
                <div className="p-6">
                  <div className="flex gap-6 mb-4 text-sm text-[var(--aairo-slate-500)]">
                    <span>{post.date}</span>
                    <span>{post.readTime}</span>
                  </div>
                  <h3 className="text-xl font-bold mb-4 text-[var(--aairo-text-primary)] transition-colors duration-300 group-hover:text-[var(--aairo-info)]">
                    {post.title}
                  </h3>
                  <p className="text-[var(--aairo-text-secondary)] mb-6 leading-relaxed">
                    {post.excerpt}
                  ...
                  <div className="flex gap-2">
                    {post.tags.map((tag, index) => (
                      <span
                        key={index}
                        className="bg-[var(--aairo-purple-20)] text-[var(--aairo-purple)] px-3 py-1 rounded-full text-xs font-semibold tracking-wider"
                      >
                        {tag}
                      </span>
                    ))}
      ...
      <div className="text-center bg-[var(--aairo-surface)]">
        <div className="p-12">
          <h3 className="text-3xl md:text-5xl font-bold mb-6 text-[var(--aairo-cyan)]">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <div className="inline-flex items-center rounded-full border px-8 py-3 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent hover:bg-secondary/80 bg-[var(--aairo-cyan-20)] text-[var(--aairo-cyan)]">
              Innovation
            </div>
            <div className="inline-flex items-center rounded-full border px-8 py-3 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent hover:bg-secondary/80 bg-[var(--aairo-green-20)] text-[var(--aairo-green)]">
              Collaboration
            </div>
            <div className="inline-flex items-center rounded-full border px-8 py-3 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent hover:bg-secondary/80 bg-[var(--aairo-blue-20)] text-[var(--aairo-blue)]">
              Learning
            </div>
            <div className="inline-flex items-center rounded-full border px-12 py-3 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent hover:bg-secondary/80 bg-[var(--aairo-lilac-20)] text-[var(--aairo-lilac)]">
              Growth
            </div>
          </div>
          <button className="inline-flex items-center justify-center gap-2 text-lg hover:bg-primary/90 h-11 rounded-md bg-gradient-to-r from-[var(--aairo-cyan)] to-[var(--aairo-blue)] text-[var(--aairo-black-04)] hover:scale-105 transition-transform cursor-pointer animate-pulse font-semibold px-14 py-8">
            Join WhatsApp Group
          </button>
        </div>
      </div>
